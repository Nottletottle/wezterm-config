...
local window_config = {
	...
	background = {
		...
		opacity_full = 1.0,
		opacity_transparent = 0.30,
		overlay_opacity_full = 0.96,
		overlay_opacity_transparent = 0.86,
		is_transparent = true,
	},
}
...
local function setup_appearance(config)
	...
	config.background = {
		...
		-- Subsequent layers are rendered over the top of each other
		{
			...
			opacity = window_config.background.overlay_opacity_full,
			height = cover,
			width = cover,
			hsb = dimmer,
			attachment = fixed,
	...
	local keys = {
		...
		-- Opacity toggle (Alt + O)
		{
			...
			action = wezterm.action_callback(function(window, pane)
				...
				local new_opacity, new_overlay_opacity =
					window_config.background.is_transparent and window_config.background.opacity_transparent,
					window_config.background.overlay_opacity_transparent or window_config.background.opacity_full,
					window_config.background.overlay_opacity_full
